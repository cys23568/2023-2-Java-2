...
public class Singleton {
    private Singleton () {}                   //프라이빗 싱글톤 기본생산자 생성 객체화 막힘 내부에서는 객체화가능 싱긅온:객체하나써서 돌려쓰겟다
...
class SingetonTeset {
    public static void main(String[] args) {
        ...
        Singleton s1 = Singleton.getInstance(); //앞에 대문자로시작 스ㅐ틱메소드라는걸 알 수가 잇다. 그래서 s1 과 s2 같다 같은주소르 공유함
